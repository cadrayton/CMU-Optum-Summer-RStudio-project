...
## Hypothesis 1:The Government Facility Type will have the lowest Rating Overall

Based on the number of observations per facility type. Private hospitals have the highest number of 1 star ratings, 2 star ratings, 3 star ratings, 4 star ratings and 5 star ratings
...
---
## Hypothesis 2: The Average Overall cost across all four procedures, in a state, will be highest in states with the highest population`#`
...
```{r plot-example, echo = FALSE, eval=requireNamespace("ggplot2", quietly=TRUE)}
library(ggplot2)
library(dplyr)
library(tidyverse)
...
```{r plot-example-themed, echo = FALSE, eval=requireNamespace("showtext", quietly=TRUE) && requireNamespace("ggplot2", quietly=TRUE)}
a + xaringanthemer::theme_xaringan(text_font_size = 16, title_font_size = 18) +
  ggtitle("Private Hospitals Have the Highest Rating Overall")
```
